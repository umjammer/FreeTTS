...
public class Player extends JFrame {
    ...
    private static final String globalFontFace = "Arial";
     ...
     *
     * @param fontSize the change in font size
     */
    ...
    public void setVoice(String voiceName) {
        ...
        ListModel<SynthesizerModeDesc> descList = (ListModel) model.getSynthesizerList();
        for (int i = 0; i < descList.getSize(); i++) {
            SynthesizerModeDesc desc = descList.getElementAt(i);
...
class PlayerMenuBar extends JMenuBar {
    ...
    private static final char crossPlatformMnemonic = 'C';
    private static final char exitMnemonic = 'X';
    private static final char fileMnemonic = 'F';
    private static final char hideMonitorMnemonic = 'H';
    private static final char jsmlMnemonic = 'J';
    private static final char monitorMnemonic = 'M';
    private static final char showMonitorMnemonic = 'S';
    private static final char speakMnemonic = 'S';
    private static final char styleMnemonic = 'E';
    private static final char styleLFMnemonic = 'L';
    private static final char systemMnemonic = 'S';
    private static final char textMnemonic = 'T';
    private static final char urlMnemonic = 'U';

    /**
     * Constructs a menubar with the given Player data model.
     *
     * @param player the Player data model
     */
    ...
    private void addFileMenuListeners() {
        ...
        fileSpeakJSMLMenuItem.addActionListener(e -> {
            File file = chooseFile();
            if (file != null) {
                playPlayable(Playable.createJSMLFilePlayable(file));
            }
        });
        fileSpeakTextMenuItem.addActionListener(e -> {
            File file = chooseFile();
            if (file != null) {
    ...
    private void addStyleMenuListeners() {
        styleLFCrossPlatformMenuItem.addActionListener(e -> player.setLookAndFeel
                (UIManager.getCrossPlatformLookAndFeelClassName()));
        styleLFSystemMenuItem.addActionListener(e -> player.setLookAndFeel
