...
public class Unit {
    ...
    public String toString() {
        ...
        if (previous != null) {
            buf.append(previous.unitType).append("_").append(previous.unitNum).append(" ");
        } else {
            buf.append("CLUNIT_NONE ");
        }
        buf.append(unitType).append("_").append(unitNum);
        if (next != null) {
            buf.append(" ").append(next.unitType).append("_").append(next.unitNum);
        } else {
            buf.append(" CLUNIT_NONE");
        }
