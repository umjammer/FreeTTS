...
public class MixedVoices {
    ...
    public static void main(String[] argv) {
        ...
        for (String s : argv) {
            if (s.equals("-showEvents")) {
                showEvents = true;
            } else if (s.equals("-showPropertyChanges")) {
        ...
        //
        Voice alan = new Voice("alan", Voice.GENDER_DONT_CARE, Voice.AGE_DONT_CARE, null);

        // kevin in a 8khz general domain diphone voice
        //
        Voice kevin = new Voice("kevin", Voice.GENDER_DONT_CARE, Voice.AGE_DONT_CARE, null);
            ...
            if (showEvents) {
                synthesizer1.addSpeakableListener(
                        new SpeakableAdapter() {
                            @Override public void markerReached(SpeakableEvent e) {
                                dumpEvent(e);
                            }

                            @Override public void speakableCancelled(SpeakableEvent e) {
                                dumpEvent(e);
                            }

                            @Override public void speakableEnded(SpeakableEvent e) {
                                dumpEvent(e);
                            }

                            @Override public void speakablePaused(SpeakableEvent e) {
                                dumpEvent(e);
                            }

                            @Override public void speakableResumed(SpeakableEvent e) {
                                dumpEvent(e);
                            }

                            @Override public void speakableStarted(SpeakableEvent e) {
                                dumpEvent(e);
                            }

                            @Override public void topOfQueue(SpeakableEvent e) {
                                dumpEvent(e);
                            }

                            @Override public void wordStarted(SpeakableEvent e) {
                                dumpEvent(e);
                            }
